...
package com.lanrhyme.micyou.ui.visualizer
...
object VisualizerConstants {
    ...
    const val RIPPLE_BAR_COUNT = 48
    const val RIPPLE_BASE_INNER_RADIUS = 0.45f
    const val RIPPLE_BAR_HEIGHT_FACTOR = 0.18f
    const val RIPPLE_RING_WIDTH_BASE = 4f
    ...
    const val CONNECTING_ARC_SWEEP_BASE = 50f

    // 动画时长配置
    const val ANIM_DURATION_BREATH = 1800
    const val ANIM_DURATION_WAVE = 2500
    const val ANIM_DURATION_GLOW = 2000
    const val ANIM_DURATION_ROTATION = 2500
    const val ANIM_DURATION_PULSE = 1200
...
fun AudioVisualizer(
    ...
    val breathScale = rememberBreathAnimation(
        minValue = 0.97f,
        maxValue = 1.03f,
        durationMillis = VisualizerConstants.ANIM_DURATION_BREATH
    )
    val wavePhase = rememberWaveAnimation(
        phaseOffset = 0f,
        durationMillis = VisualizerConstants.ANIM_DURATION_WAVE
    )
...
private fun RippleVisualizer(
    ...
    val ringCount = VisualizerConstants.RIPPLE_RING_COUNT
    val barCount = VisualizerConstants.RIPPLE_BAR_COUNT
    val baseInnerRadius = VisualizerConstants.RIPPLE_BASE_INNER_RADIUS
    val barHeightFactor = VisualizerConstants.RIPPLE_BAR_HEIGHT_FACTOR
    val ringWidthBase = VisualizerConstants.RIPPLE_RING_WIDTH_BASE
...
fun ConnectingAnimation(
    ...
    val rotation = com.lanrhyme.micyou.animation.rememberRotationAnimation(
        durationMillis = VisualizerConstants.ANIM_DURATION_ROTATION
    )
    val pulse = com.lanrhyme.micyou.animation.rememberPulseAnimation(
        minValue = 0.92f,
        maxValue = 1.08f,
        durationMillis = VisualizerConstants.ANIM_DURATION_PULSE
    )
    ...
    val radius = min(size.width, size.height) / 2
        ...
        for (i in 0..VisualizerConstants.CONNECTING_ARC_COUNT) {
            ...
            val sweepAngle = VisualizerConstants.CONNECTING_ARC_SWEEP_BASE + 30f * sin(rotation * 0.025f)
    val radiusFactor = 0.45f + i * 0.18f
